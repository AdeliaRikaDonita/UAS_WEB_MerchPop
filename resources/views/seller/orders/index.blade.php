...
<h1 class="text-2xl font-bold text-plum-800 mb-6">Pesanan Masuk</h1>

<div class="bg-white rounded-xl border border-plum-100 divide-y divide-blush-50">
    @forelse($orders as $order)
    <a href="{{ route('seller.orders.show', $order) }}" class="block p-4 hover:bg-blush-50/50 transition">
        <div class="flex flex-wrap justify-between items-center gap-2">
            ...
            <div class="flex items-center gap-3">
                ...
                <span class="font-bold text-plum-800 text-sm">
    ...
    @empty
    <p class="p-8 text-center text-plum-400 text-sm">Belum ada pesanan masuk.</p>
    @endforelse
</div>
